...
Серед програмістів досить поширена практика копіювання та вставки коду. Не дивлячись на те, що це може бути корисним та зручним навиком у короткостроковій перспективі, подібна практика призводить до катастрофічних наслідків при обслуговуванні програмного забезпечення. \\ Так, наприклад, якщо потрібно зробити усунення помилки у повторюваній частині, то його потрібно бути зробити для кожної копії, тобто необхідна робота збільшується у декілька разів. Пошук повторюваних частин є необхідним при пошуці комп'ютерних вірусів, виявленні помилок у коді, оцінці якості початкового коду програмного забезпечення, виявленні плагіату. %% TODO  
\newpage
