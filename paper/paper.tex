...
Існують різні способи порівняння методів пошуку дублікатів у коді, доволі використованим способом є бенчмарк \cite{Bellon07}. \\
...
\end{itemize}
Для експерименту обрані наступні програми:
\begin{itemize}
\item CCFinderX;
\item PMD;
\item Bauhaus;
...
\begin{itemize}
\item процесор -- \verb|Intel Xeon Platinum 8171M|, 2.60Ггц (використовується лише 4 ядра із 26);
\item оперативна пам'ять -- 16 Гб;
\item операційна система -- \verb|Ubuntu Server 18.04|.
\end{itemize} 
За результатами експерименту отримані наступні результати: \\
\begin{center}
 \begin{tabular}{| c | c | c |} 
 \hline
