...
\item{відсортувати масив за зростанням функції $f(list)=max(piece_{y})$
...
$goodGraphs$ -- кількість графів (окрім першого), для яких відстань зміни графа (<<TED>>) є меншою за константу $T$. \\
%TODO приклад графа
...
$F(len)$ повинно бути більше ніж 0, бо у інакшому випадку опрацювання цього коду не матиме сенсу.
\end{enumerate}
}
\end{itemize}
\subsection{Перетворення на фрагменти у коді}
