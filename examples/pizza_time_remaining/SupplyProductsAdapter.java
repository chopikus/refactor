...
public class SupplyProductsAdapter extends RecyclerView.Adapter<SupplyProductsAdapter.MyViewHolder> {

    private ArrayList<SupplyProductsModel> dataSet;
    LayoutInflater inflater;

    public SupplyProductsAdapter(Context context, List<SupplyProductsModel> list) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.supply_products_layout, parent, false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView textViewName,textViewId, textViewCount, textViewDate,textViewCode;
        LinearLayout rowFG;
        ...
        public void bindData(SupplyProductsModel rowModel) {
            ...
            textViewCount.setText(rowModel.getAmount());
            ...
            if (getTimeRemaining(rowModel.getExpireDate())<2) {
                rowFG.setBackgroundColor(Color.parseColor("#ff9900"));
                textViewDate.setText("Срок годности: \n"+rowModel.getExpireDate()+"\nИстекает!");
            }
            else
